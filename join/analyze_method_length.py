...
def scan_all_ts_files():
    ...
    for file_path in files:
        ...
        if long_methods:
            ...
            for method in long_methods:
                print(f"  📍 {method['method_name']} (Line {method['start_line']}-{method['end_line']})")
    ...
    print(f"\n" + "="*80)
    print(f"=== TOP 10 LONGEST METHODS ===")
    print(f"="*80)
    ...
    if len(all_long_methods) == 0:
        ...
        print(f"⚠️  Consider refactoring methods longer than 20-25 lines")
